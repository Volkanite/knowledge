Step 1, Create SSH key. The command below creates a key file named id_ed25519 is your User's folder. You can see this file in your file browser (Windows Explorer) to navigate to C:\Users\YOUR_USERNAME\.ssh
